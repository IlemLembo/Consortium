...
class CustomUserCreationForm(UserCreationForm):
    ...
    role = forms.ChoiceField(choices=ROLES_CHOICES, required=True, widget= forms.ChoiceField)
...
class User_Form(UserCreationForm):
    ...
    SUBSCRIBER = 'SUBSCRIBER'
    ROLES_CHOICES = (
        (CREATOR, "Je veux Promouvoir ma Musique"),
        (SUBSCRIBER, "Je veux ecouter des Artistes"),
    )

    email = forms.EmailField(widget=forms.EmailInput, label="Email")
    role = forms.ChoiceField(choices=ROLES_CHOICES, required=True, widget= forms.RadioSelect, label='Rôle')
